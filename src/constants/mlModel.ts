...
export const NUM_FRAMES = 200; // expected MFCC time steps for 2 seconds of 16 kHz input
...
// Current bundled waveform TFLite model requires this exact sample count.
// 23680 samples at 16kHz is ~1.48s (not exactly 1.5s).
export const WAVEFORM_MODEL_REQUIRED_SAMPLES = 23680;
